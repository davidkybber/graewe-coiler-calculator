...
export const CalculatorInputs: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <details className="bg-graewe-gray-50 p-4 md:p-6 rounded-lg">
        <summary className="text-base md:text-lg font-semibold text-graewe-dark cursor-pointer mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            <label htmlFor="numberOfLayers" className="block text-sm font-medium text-graewe-dark mb-2">
              Lageanzahl i [oE]
            </label>
            <input
              id="numberOfLayers"
              ...
              onChange={(e) => handleNumberChange('numberOfLayers', e.target.value)}
              className={`input-field ${errors.numberOfLayers ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
              placeholder="Automatisch"
              data-testid="number-of-layers-input"
            />
            {errors.numberOfLayers && (
              <p className="mt-1 text-sm text-red-600">{errors.numberOfLayers}</p>
            )}
          </div>

          <div>
            <label htmlFor="numberOfRotations" className="block text-sm font-medium text-graewe-dark mb-2">
            ...
            <input
              ...
              min="1"
              max="1000"
              value={params.numberOfRotations || ''}
              onChange={(e) => handleNumberChange('numberOfRotations', e.target.value)}
              className={`input-field ${errors.numberOfRotations ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
              placeholder="Automatisch"
              data-testid="number-of-rotations-input"
            />
            {errors.numberOfRotations && (
              <p className="mt-1 text-sm text-red-600">{errors.numberOfRotations}</p>
            )}
          </div>
        </div>
      </details>
